...
# [1] ---- Load global data ----
    ...
    pal_education_1 <- colorNumeric(palette = c("white","darkred"),domain = map$education_score)
    ...
    pal_census_1 <- colorNumeric(palette = c("white","darkblue"),domain = map$usual_resident_population)
    pal_census_2 <- colorNumeric(palette = c("white","darkblue"),domain = map$working_age_proportion)
    pal_census_3 <- colorNumeric(palette = c("white","darkblue"),domain = map$senior_citizen_proportion)
    pal_seifa_1 <- colorNumeric(palette = c("white","purple"),domain = map$seifa_econ_disadvantage)
    pal_seifa_2 <- colorNumeric(palette = c("white","purple"),domain = map$seifa_econ_adv_disadv)
    pal_seifa_3 <- colorNumeric(palette = c("white","purple"),domain = map$seifa_econ_resources)
    pal_seifa_4 <- colorNumeric(palette = c("white","purple"),domain = map$seifa_education_occupation)
    pal_housing_1 <- colorNumeric(palette = c("white","pink"),domain = map$house_and_semi_proportion)
    pal_housing_2 <- colorNumeric(palette = c("white","pink"),domain = map$unit_proportion)
    pal_housing_3 <- colorNumeric(palette = c("white","pink"),domain = map$dwelling_density)
    pal_prices_1 <- colorNumeric(palette = c("white","darkred"),domain = map$median_land_value_per_sqm)
    pal_prices_2 <- colorNumeric(palette = c("white","darkred"),domain = map$house_median_suburb)
    pal_prices_3 <- colorNumeric(palette = c("white","darkred"),domain = map$apartment_median_suburb)
