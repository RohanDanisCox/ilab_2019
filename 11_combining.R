...
# [3] ---- Handling Seifa scores ----
  
  # Create a function to interpolate scores
  interpolate_scores <- function(df,var) {
    use_var <- enquo(var)
  ...
  usual_res_pop <- interpolate_scores(seifa_scores,usual_resident_population)
  rel_dis <- interpolate_scores(seifa_scores, relative_socio_economic_disadvantage_index)
  rel_adv_dis<- interpolate_scores(seifa_scores, relative_socio_economic_adv_disadv_index)
  eco_res <- interpolate_scores(seifa_scores, economic_resources_index)
  edu_occ <- interpolate_scores(seifa_scores, education_and_occupation_index)
